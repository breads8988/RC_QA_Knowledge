...
# Test Case Register — My Vehicle (`MV`)
...
> **Note:** Vehicle ownership (Owner / Rental, default Owner) is verified under the `registration` feature — see feature `REG` (AC-REG-35 / BR-REG-11). Not duplicated here.
