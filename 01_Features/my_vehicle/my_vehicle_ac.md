...
# Acceptance Criteria — My Vehicle (`MV`)
...
> One row = one scenario. Sourced from the Figma design (`01_Features/my_vehicle/screens`) as RC-109 / RC-105 carry no detailed spec of their own. Fields observed in German are noted with an English gloss.
...
- **Downward**: `Linked TCs` lists the verifying test cases in `01_Features/my_vehicle/my_vehicle_tc.md`.
